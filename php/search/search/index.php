<?php
	$conn = mysqli_connect("localhost", "root", "", "gazzete");	
	$with_any_one_of = "";
	$with_the_exact_of = "";
	$without = "";
	$starts_with = "";
	...
	$sql = "SELECT * FROM student " . $queryCondition;
...
<html>
    ...
    <div>      
			...
			<div>
				<div><strong><?php echo $row["s_name"]; ?></strong></div>
				<div class="result-description"><?php echo $row["s_class"]; ?></div>
			</div>
			<?php } ?>
